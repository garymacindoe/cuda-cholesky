...
template __global__ void reduce<512,  true>(const float *, float *, int, int);
template __global__ void reduce<256,  true>(const float *, float *, int, int);
template __global__ void reduce<128,  true>(const float *, float *, int, int);
template __global__ void reduce< 64,  true>(const float *, float *, int, int);
template __global__ void reduce< 32,  true>(const float *, float *, int, int);
template __global__ void reduce< 16,  true>(const float *, float *, int, int);
template __global__ void reduce<  8,  true>(const float *, float *, int, int);
template __global__ void reduce<  4,  true>(const float *, float *, int, int);
template __global__ void reduce<  2,  true>(const float *, float *, int, int);
template __global__ void reduce<  1,  true>(const float *, float *, int, int);

template __global__ void reduce<512, false>(const float *, float *, int, int);
template __global__ void reduce<256, false>(const float *, float *, int, int);
template __global__ void reduce<128, false>(const float *, float *, int, int);
template __global__ void reduce< 64, false>(const float *, float *, int, int);
template __global__ void reduce< 32, false>(const float *, float *, int, int);
template __global__ void reduce< 16, false>(const float *, float *, int, int);
template __global__ void reduce<  8, false>(const float *, float *, int, int);
template __global__ void reduce<  4, false>(const float *, float *, int, int);
template __global__ void reduce<  2, false>(const float *, float *, int, int);
template __global__ void reduce<  1, false>(const float *, float *, int, int);
