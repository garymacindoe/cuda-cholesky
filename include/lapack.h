...
// In-place single precision triangular inverse
void strtri(CBlasUplo, CBlasDiag, size_t, float * restrict, size_t, long * restrict);

// Out-of-place single precision triangular inverse
...
// In-place single precision complex triangular inverse
void ctrtri(CBlasUplo, CBlasDiag, size_t, float complex * restrict, size_t, long * restrict);

// Out-of-place single precision complex triangular inverse
...
// In-place double precision triangular inverse
void dtrtri(CBlasUplo, CBlasDiag, size_t, double * restrict, size_t, long * restrict);

// Out-of-place double precision triangular inverse
...
// In-place double precision complex triangular inverse
void ztrtri(CBlasUplo, CBlasDiag, size_t, double complex * restrict, size_t, long * restrict);

// Out-of-place double precision complex triangular inverse
