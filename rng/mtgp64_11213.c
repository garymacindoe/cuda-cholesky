...
typedef struct {
  unsigned int mexp, pos, sh1, sh2;
  uint64_t tbl[16], tmp_tbl[16], dbl_tmp_tbl[16];
  uint64_t mask;
  unsigned char poly_sha1[21];
} mtgp64_params_fast_t;

static const mtgp64_params_fast_t mtgp64dc_params[] = {
    {
...
#define NAME "64-bit Mersenne Twister for Graphics Processors 2^11213"
#define RNG_T mtgp64_11213_t
#include "mtgp64.c"
