 ...
 */
template __global__ void cherk<CBlasUpper, CBlasNoTrans,   64,  8,  8,  8,  8>(const cuComplex *, cuComplex *, float, float, int, int, int, int);
template __global__ void cherk<CBlasLower, CBlasNoTrans,   64,  8,  8,  8,  8>(const cuComplex *, cuComplex *, float, float, int, int, int, int);
template __global__ void cherk<CBlasUpper, CBlasConjTrans, 32, 16,  8,  8,  8>(const cuComplex *, cuComplex *, float, float, int, int, int, int);
template __global__ void cherk<CBlasLower, CBlasConjTrans, 32, 16,  8,  8,  8>(const cuComplex *, cuComplex *, float, float, int, int, int, int);
