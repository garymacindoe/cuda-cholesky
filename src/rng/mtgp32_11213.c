...
typedef struct {
  ...
  uint32_t tbl[16], tmp_tbl[16], flt_tmp_tbl[16];
  uint32_t mask;
  unsigned char poly_sha1[21];
} mtgp32_params_fast_t;

static const mtgp32_params_fast_t mtgp32dc_params[] = {
    {
...
#define NAME "Mersenne Twister for Graphics Processors 2^11213"
#define RNG_T mtgp32_11213_t
#include "mtgp32.c"
