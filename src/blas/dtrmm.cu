...
#pragma unroll
        for (int ll = 0; ll < kb; ll++) {
          if (ti <= l++)
            daxpy((trans == CBlasNoTrans) ? A[0]
                                          : __hiloint2double(a_hi[ti][ll], a_lo[ti][ll]),
...
#pragma unroll
        for (int j = 0; j < nb; j += by) {
          a_hi[threadIdx.x][j + threadIdx.y] =
            (diag != CBlasNonUnit && threadIdx.x == j + threadIdx.y) ? __double2hiint(1.0) : __double2hiint(A[j * lda]);
          a_lo[threadIdx.x][j + threadIdx.y] =
            (diag != CBlasNonUnit && threadIdx.x == j + threadIdx.y) ? __double2loint(1.0) : __double2loint(A[j * lda]);
        }
      }
      else {
#pragma unroll
        for (int l = 0; l < kb; l += by) {
          a_hi[l + threadIdx.y][threadIdx.x] =
            (diag != CBlasNonUnit && threadIdx.x == l + threadIdx.y) ? __double2hiint(1.0) : __double2hiint(A[l * lda]);
          a_lo[l + threadIdx.y][threadIdx.x] =
            (diag != CBlasNonUnit && threadIdx.x == l + threadIdx.y) ? __double2loint(1.0) : __double2loint(A[l * lda]);
        }
      }
...
template void dtrmm2R<CBlasUpper, CBlasNoTrans, CBlasUnit,    64,  8,  8,  8,  8>(int, int, double, const double * __restrict__, int, const double * __restrict__, int, double * __restrict__, int);
template void dtrmm2R<CBlasUpper, CBlasNoTrans, CBlasNonUnit, 64,  8,  8,  8,  8>(int, int, double, const double * __restrict__, int, const double * __restrict__, int, double * __restrict__, int);
template void dtrmm2R<CBlasUpper, CBlasTrans,   CBlasUnit,    64,  8,  8,  8,  8>(int, int, double, const double * __restrict__, int, const double * __restrict__, int, double * __restrict__, int);
template void dtrmm2R<CBlasUpper, CBlasTrans,   CBlasNonUnit, 64,  8,  8,  8,  8>(int, int, double, const double * __restrict__, int, const double * __restrict__, int, double * __restrict__, int);
template void dtrmm2R<CBlasLower, CBlasNoTrans, CBlasUnit,    64,  8,  8,  8,  8>(int, int, double, const double * __restrict__, int, const double * __restrict__, int, double * __restrict__, int);
template void dtrmm2R<CBlasLower, CBlasNoTrans, CBlasNonUnit, 64,  8,  8,  8,  8>(int, int, double, const double * __restrict__, int, const double * __restrict__, int, double * __restrict__, int);
template void dtrmm2R<CBlasLower, CBlasTrans,   CBlasUnit,    64,  8,  8,  8,  8>(int, int, double, const double * __restrict__, int, const double * __restrict__, int, double * __restrict__, int);
template void dtrmm2R<CBlasLower, CBlasTrans,   CBlasNonUnit, 64,  8,  8,  8,  8>(int, int, double, const double * __restrict__, int, const double * __restrict__, int, double * __restrict__, int);
