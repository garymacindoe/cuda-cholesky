 ...
 *
 * A is upper or lower triangular - m*m when side is CBlasLeft and n*n when side
 * is CBlasRight.  It may also be unit or non-unit diagonal.
 *
 ...
 * @param diag   whether the entries along the diagonal of A are unit (1.0) or
                   non-unit.
 * @param mb     the number of rows in the block of X.
 * @param nb     the number of columns in the block of X.
...
__global__ void strmm(int m, int n, float alpha,
  ...
  // Work out k for each thread based on the uplo
  int k;
...
#pragma unroll
  ...
  if (trans == CBlasNoTrans)
    ...
    n -= bj + 16 * (ti / mb);
  if (n <= 0) return;
  if ((trans == CBlasNoTrans && bi + ti < m) || (trans != CBlasNoTrans && bi + ti % mb < m)) {
 ...
 */
template void strmm<CBlasLeft,  CBlasUpper, CBlasNoTrans, CBlasNonUnit, 64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasLeft,  CBlasUpper, CBlasNoTrans, CBlasUnit,    64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasLeft,  CBlasUpper, CBlasTrans,   CBlasNonUnit, 32, 32,  8,  8, 8>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasLeft,  CBlasUpper, CBlasTrans,   CBlasUnit,    32, 32,  8,  8, 8>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasLeft,  CBlasLower, CBlasNoTrans, CBlasNonUnit, 64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasLeft,  CBlasLower, CBlasNoTrans, CBlasUnit,    64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasLeft,  CBlasLower, CBlasTrans,   CBlasNonUnit, 64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasLeft,  CBlasLower, CBlasTrans,   CBlasUnit,    64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasRight, CBlasUpper, CBlasNoTrans, CBlasNonUnit, 64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasRight, CBlasUpper, CBlasNoTrans, CBlasUnit,    64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasRight, CBlasUpper, CBlasTrans,   CBlasNonUnit, 32, 32,  8,  8, 8>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasRight, CBlasUpper, CBlasTrans,   CBlasUnit,    32, 32,  8,  8, 8>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasRight, CBlasLower, CBlasNoTrans, CBlasNonUnit, 64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasRight, CBlasLower, CBlasNoTrans, CBlasUnit,    64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasRight, CBlasLower, CBlasTrans,   CBlasNonUnit, 64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
template void strmm<CBlasRight, CBlasLower, CBlasTrans,   CBlasUnit,    64, 16, 16, 16, 4>strmm(int, int, float, const float * __restrict__, int, const float * __restrict__, int, float * __restrict__);
