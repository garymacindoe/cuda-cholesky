...
template __global__ void ztrmmLUN<CBlasUnit,    64,  4, 16, 16,  4>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmLUN<CBlasNonUnit, 64,  4, 16, 16,  4>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmLUT<CBlasTrans,     CBlasUnit,    8, 8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmLUT<CBlasTrans,     CBlasNonUnit, 8, 8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmLUT<CBlasConjTrans, CBlasUnit,    8, 8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmLUT<CBlasConjTrans, CBlasNonUnit, 8, 8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmLLN<CBlasUnit,    64,  4, 16, 16,  4>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmLLN<CBlasNonUnit, 64,  4, 16, 16,  4>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmLLT<CBlasTrans,     CBlasUnit,    8, 8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmLLT<CBlasTrans,     CBlasNonUnit, 8, 8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmLLT<CBlasConjTrans, CBlasUnit,    8, 8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmLLT<CBlasConjTrans, CBlasNonUnit, 8, 8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);

template __global__ void ztrmmRUN<CBlasUnit,    64,  4, 16, 16,  4>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmRUN<CBlasNonUnit, 64,  4, 16, 16,  4>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmRUT<CBlasTrans,     CBlasUnit,     8,  8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmRUT<CBlasTrans,     CBlasNonUnit,  8,  8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmRUT<CBlasConjTrans, CBlasUnit,     8,  8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmRUT<CBlasConjTrans, CBlasNonUnit,  8,  8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmRLN<CBlasUnit,    64,  4, 16, 16,  4>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmRLN<CBlasNonUnit, 64,  4, 16, 16,  4>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmRLT<CBlasTrans,     CBlasUnit,     8,  8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmRLT<CBlasTrans,     CBlasNonUnit,  8,  8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmRLT<CBlasConjTrans, CBlasUnit,     8,  8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
template __global__ void ztrmmRLT<CBlasConjTrans, CBlasNonUnit,  8,  8,  4,  4,  8>(cuDoubleComplex, const cuDoubleComplex * __restrict__, const cuDoubleComplex * __restrict__, cuDoubleComplex * __restrict__, int, int, int, int, int);
